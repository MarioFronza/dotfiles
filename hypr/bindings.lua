...
-- Gamer mode: stop Docker, launch Steam Big Picture in gamescope.
o.bind("SUPER + SHIFT + G", "Gamer mode", "gamer-mode")
-- Force-exit gamescope if it doesn't hand back the desktop on quit.
o.bind("SUPER + SHIFT + R", "Gamer mode exit", "gamer-mode-exit")
